...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Oui ! La piscine est privée, entièrement dédiée au(x) locataire(s).",
  },
  {
...
function FAQ() {
  return (
    <section
      id="faq"
      className="mt-12 border-y bg-zinc-100 font-sans dark:bg-zinc-800 "
    >
      <div className="mx-auto max-w-7xl py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl divide-y-2 divide-gray-200">
          <h2 className="text-center font-['allura'] text-3xl font-bold tracking-tight sm:text-4xl">
            Des questions ?
          </h2>
